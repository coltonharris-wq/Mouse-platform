...
const stats = [
  { label: 'Total Earnings', value: '$12,450', change: '+23.5%', trend: 'up', icon: DollarSign },
  { label: 'Active Customers', value: '24', change: '+5', trend: 'up', icon: Users },
  { label: 'Commission Rate', value: '40%', change: 'Fixed', trend: 'neutral', icon: Percent },
  { label: 'Pending Payout', value: '$3,200', change: 'Due Feb 28', trend: 'neutral', icon: Wallet },
];
    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-2xl font-bold text-[#1e3a5f]">Reseller Dashboard</h1>
        ...
        {/* Referral Link */}
        <div className="bg-gradient-to-r from-[#1e3a5f] to-[#2d4a6f] rounded-xl p-6 text-white mb-8">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              <code className="bg-white/20 px-4 py-2 rounded-lg text-sm flex-1 md:flex-none truncate">{referralLink}</code>
              <button
                onClick={copyLink}
                className="flex items-center gap-2 px-4 py-2 bg-white text-[#1e3a5f] rounded-lg hover:bg-blue-50 transition-colors whitespace-nowrap"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
            <div className="p-6 border-b border-gray-200">
              <div className="flex justify-between items-center">
                <h2 className="text-lg font-semibold text-[#1e3a5f]">Recent Customers</h2>
                <Link href="/dashboard/reseller/customers" className="text-[#1e3a5f] hover:text-[#2d4a6f] text-sm">
                  View All
                </Link>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-[#1e3a5f]">Commission History</h2>
            </div>
            <div className="divide-y divide-gray-200">
