  ...
  return (
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl font-bold text-[#1e3a5f] mb-4">Account Settings</h1>
        ...
        <div className="mt-8 bg-white rounded-xl border border-gray-200 shadow-sm p-12 text-center">
          ...
          <p className="text-gray-600 max-w-md mx-auto">Update your profile, change password, and manage preferences.</p>
        </div>
      </div>
    </div>
  );
