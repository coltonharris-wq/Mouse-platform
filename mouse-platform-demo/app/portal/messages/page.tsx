      ...
      <div className="grid lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="p-4">
              <button className="w-full bg-orange-500 text-white py-2.5 rounded-lg font-medium hover:bg-mouse-navy transition-colors flex items-center justify-center gap-2">
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
                      message.category === "support" ? "bg-teal-100" : "bg-blue-100"
                    }`}>
                      <MessageSquare className={`w-5 h-5 ${
                        message.category === "support" ? "text-[#0B1F3B]" : "text-blue-600"
                      }`} />
                    </div>
