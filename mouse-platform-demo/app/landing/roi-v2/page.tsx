...
const testimonials = [
  {
    quote:
      "We were bleeding money on admin tasks. Mouse plugged the leak and gave us our cash flow back.",
    name: "Michael Torres",
    title: "CFO, Pinnacle Logistics",
    savings: "$52,000/year",
  },
  {
    quote:
      "I finally understand why they call it 'hiring an employee' — it really feels like having a team member.",
    name: "Rebecca Walsh",
    title: "Founder, Bloom Wellness Studio",
    savings: "$31,200/year",
  },
  {
    quote:
      "The $4.98/hour price seemed too good to be true. Six months later, it's our best business decision.",
    name: "David Kim",
    title: "Operations Manager, Atlas Manufacturing",
    savings: "$45,600/year",
  },
];
...
const useCases = [
  {
    ...
    description: "Use savings to hire specialists for growth initiatives",
  },
  {
    icon: Briefcase,
    title: "Work-life balance",
    description: "Delegate after-hours tasks to your AI employee",
  },
  {
    icon: TrendingUp,
    title: "Reinvest profits",
    description: "Put the savings toward marketing, R&D, or equipment",
  },
];

export default function ROILandingPageV2() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section - Variant 2: Focus on Hiring Alternative */}
      <section className="bg-mouse-navy pt-16 pb-12 sm:pt-20 sm:pb-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-mouse-orange/20 border border-mouse-orange/30 rounded-full px-4 py-2 mb-6">
            <span className="text-mouse-orange font-bold text-lg">7x Cheaper</span>
            <span className="text-white/80 text-sm">than a full-time hire</span>
          </div>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight">
            Your Next Hire Costs $4.98/Hour
          </h1>
          <p className="mt-4 text-xl sm:text-2xl text-mouse-slate">
            Fully trained AI employees. No recruiting. No onboarding. No drama.
          </p>
        </div>
      </section>
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-4 py-2 mb-4">
              ...
              <span className="text-mouse-green font-semibold">
                Trusted by 500+ businesses saving $28,400/year on average
              </span>
            </div>
          </div>
      ...
      <section className="bg-mouse-navy py-16 sm:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-mouse-slate text-center max-w-xl mx-auto mb-12">
            No technical setup required. Your AI employee is ready to work in minutes.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Choose Your Role</h3>
              <p className="text-mouse-slate text-sm">
                Sales, admin, AR, customer support — pick the employee your business needs
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Connect & Configure</h3>
              <p className="text-mouse-slate text-sm">
                Link your email, CRM, and tools. Takes 5 minutes, no IT team needed
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Start Saving</h3>
              <p className="text-mouse-slate text-sm">
                Your AI employee works 24/7. Track every dollar saved on your dashboard
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-lg text-mouse-charcoal leading-relaxed">
                  Try Mouse for 30 days risk-free. If you don&apos;t save at least{" "}
                  <span className="font-bold text-mouse-green">$1,000</span>, we&apos;ll
                  refund every penny plus pay you{" "}
                  <span className="font-bold text-mouse-green">$500</span> for your time.
                </p>
        ...
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-mouse-slate">
              2 minutes to discover how much you&apos;ll save. No credit card needed.
            </p>
          </div>
