...
const testimonials = [
  {
    quote:
      "I used to work 70-hour weeks. Now I work 45. Mouse handles the rest for the price of a dinner out.",
    name: "Daniel Rivera",
    title: "Founder, Rivera Consulting",
    savings: "$34,800/year",
  },
  {
    quote:
      "Best business decision I've made. Period. The ROI calculator doesn't lie.",
    name: "Catherine Wong",
    title: "Owner, Pacific Realty Group",
    savings: "$47,200/year",
  },
  {
    quote:
      "Small investment, massive returns. This is how you scale a business in 2025.",
    name: "Thomas Bradley",
    title: "CEO, Bradley & Associates",
    savings: "$31,600/year",
  },
];
...
const useCases = [
  {
    ...
    description: "Reclaim evenings and weekends while your AI handles the workload",
  },
  {
    icon: Briefcase,
    title: "Grow without stress",
    description: "Scale operations without the headaches of traditional hiring",
  },
  {
    icon: TrendingUp,
    title: "Maximize cash flow",
    description: "Keep more of what you earn with dramatically lower labor costs",
  },
];

export default function ROILandingPageV5() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section - Variant 5: Focus on Simplicity/Value */}
      <section className="bg-mouse-navy pt-16 pb-12 sm:pt-20 sm:pb-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-2 mb-6">
            <span className="text-white font-bold text-lg">Simple. Affordable. Powerful.</span>
          </div>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight">
            AI Employees at $4.98/Hour
          </h1>
          <p className="mt-4 text-xl sm:text-2xl text-mouse-slate">
            Enterprise capability. Small business price. No compromises.
          </p>
        </div>
      </section>
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-4 py-2 mb-4">
              ...
              <span className="text-mouse-green font-semibold">
                Join 500+ smart business owners saving with Mouse
              </span>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Choose</h3>
              <p className="text-mouse-slate text-sm">
                Pick the AI employee that fits your needs from our marketplace
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-mouse-slate text-sm">
                Link your tools — takes 5 minutes, no technical skills needed
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Save</h3>
              <p className="text-mouse-slate text-sm">
                Watch the savings add up on your dashboard in real-time
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-lg text-mouse-charcoal leading-relaxed">
                  Try Mouse for 30 days. If you don&apos;t save at least{" "}
        ...
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-mouse-slate">
              See exactly how much you&apos;ll save. No credit card needed.
            </p>
          </div>
