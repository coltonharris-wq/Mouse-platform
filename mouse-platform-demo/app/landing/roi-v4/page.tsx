...
const testimonials = [
  {
    quote:
      "Finally, technology that actually saves money instead of just promising to. Our admin costs dropped 70%.",
    name: "Steven Blake",
    title: "COO, Horizon Healthcare",
    savings: "$67,000/year",
  },
  {
    quote:
      "I was drowning in paperwork. Now I have an AI employee handling it all for less than my coffee budget.",
    name: "Lisa Park",
    title: "Solo Practitioner, Park Law",
    savings: "$22,400/year",
  },
  {
    quote:
      "Every business owner needs to see these numbers. It's not just savings — it's transformation.",
    name: "Marcus Johnson",
    title: "Founder, ScaleUp Ventures",
    savings: "$54,000/year",
  },
];
...
const useCases = [
  {
    ...
    description: "Handle growth without the cost and complexity of expanding your team",
  },
  {
    icon: Briefcase,
    title: "Focus on what matters",
    description: "Offload busywork and spend time on high-value activities",
  },
  {
    icon: TrendingUp,
    title: "Increase profitability",
    description: "Cut costs dramatically while maintaining or improving output",
  },
];

export default function ROILandingPageV4() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section - Variant 4: Focus on Business Transformation */}
      <section className="bg-mouse-navy pt-16 pb-12 sm:pt-20 sm:pb-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-mouse-teal/20 border border-mouse-teal/30 rounded-full px-4 py-2 mb-6">
            <span className="text-mouse-teal font-bold text-lg">$28,400</span>
            <span className="text-white/80 text-sm">average yearly savings</span>
          </div>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight">
            Transform Your Business for $4.98/Hour
          </h1>
          <p className="mt-4 text-xl sm:text-2xl text-mouse-slate">
            Stop overpaying for busywork. Start investing in growth.
          </p>
        </div>
      </section>
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-4 py-2 mb-4">
              ...
              <span className="text-mouse-green font-semibold">
                Join 500+ businesses already saving with Mouse
              </span>
            </div>
          </div>

          <h2 className="text-2xl sm:text-3xl font-bold text-mouse-navy text-center mb-12">
            Real Transformations. Real Savings.
          </h2>
        ...
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-mouse-slate">
              Get your free savings report. No credit card required.
            </p>
          </div>
