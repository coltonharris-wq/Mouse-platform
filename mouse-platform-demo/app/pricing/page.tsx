...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { text: "Local LLM (Qwen 0.5B)", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Kimi K2.5 LLM (Premium)", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Voice/Video calls included", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Kimi K2.5 + Custom models", included: true },
...
const comparisonFeatures = [
  ...
  { name: "LLM Model", free: "Qwen 0.5B (Local)", starter: "Kimi K2.5", growth: "Kimi K2.5", enterprise: "Kimi K2.5 + Custom" },
  { name: "Pro feature allowance", free: "$2/mo", starter: "Included", growth: "Included", enterprise: "Unlimited" },
  { name: "Voice/Video calls", free: "—", starter: "—", growth: "✓", enterprise: "✓" },
  ...
  { name: "White label", free: "—", starter: "—", growth: "—", enterprise: "✓" },
];

const faqs = [
  {
    q: "What's included in the Free plan?",
    a: "The Free plan includes 50 messages per month with a local Ollama LLM (Qwen 0.5B), 1 AI Employee, and $2 of pro feature usage for trying out premium features like calls and advanced integrations.",
  },
  {
    q: "What happens when I hit my Free plan limits?",
    a: "When you reach 50 messages, you'll see an upgrade prompt. For pro features, you get $2 of free usage, then a $3 grace period before requiring payment. You can upgrade to Pro anytime for unlimited usage.",
  },
  {
      ...
      <section className="bg-mouse-navy py-16 sm:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-mouse-slate text-base sm:text-lg max-w-xl mx-auto">
            Start free, upgrade when you are ready. No credit card required to try.
          </p>
        </div>
      </section>
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-baseline gap-1 mb-1">
                    <span className="text-3xl font-bold text-mouse-green">{plan.priceDisplay}</span>
